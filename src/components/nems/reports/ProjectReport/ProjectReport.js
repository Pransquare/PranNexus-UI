...
import { GenerateProjectReport } from "../../../../service/api/nemsService/TimeSheetService";
...
function ProjectReport() {
  ...
  const hr_tools_nems_management_project_report = UserManagentCheck(
    "hr_tools_nems_management_project_report"
  );
      ...
      .then(
        axios.spread((getallProjects, getEmployeeProjects) => {
          if (getallProjects && getEmployeeProjects) {
            const projectDetails = hr_tools_nems_management_project_report
              ? getallProjects
  ...
  }, [employeeData, hr_tools_nems_management_project_report]);
