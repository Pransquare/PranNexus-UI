...
export const AssetManagement = () => {
  ...
  const validate = useCallback(() => {
    ...
    let isValid = true;
    if (!validateAlphabets(formData.assetName)) {
      tempErrors.assetName = "Invalid asset name.";
      isValid = false;
    }
    if (!formData.assetCode.trim()) {
      tempErrors.assetCode = "Asset Code is required.";
      isValid = false;
    }
    if (!formData.assetType.trim()) {
      tempErrors.assetType = "Asset Type is required.";
      isValid = false;
    }
