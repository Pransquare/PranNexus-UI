  ...
  return (
    <Box sx={panelStyle}>
      <Tabs
        ...
        variant="scrollable"
      >
        {UserManagentCheck("hr_tools_ems_timesheet_timesheetApply") &&
          !employeeData?.genericProfile && (
            <Tab label="Timesheet Entry" value={0} />
          )}
        {UserManagentCheck("hr_tools_ems_timesheet_summary") &&
          !employeeData?.genericProfile && (
            <Tab label="Timesheet Summary" value={1} />
          )}
        {UserManagentCheck("hr_tools_ems_timesheet_Approvals") &&
          !employeeData?.genericProfile && (
            <Tab label="Timesheet Approvals" value={2} />
          )}
        {UserManagentCheck("hr_tools_ems_timesheet_report") && (
